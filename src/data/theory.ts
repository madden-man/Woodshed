...
export const TOPICS: Topic[] = [
  ...
  },
  {
    ...
    inPlainTerms:
      'A four-note chord has one note that does nothing. Drop it, keep the three that carry the sound, and your left hand has a shape it can play under anything — with two fingers free and no clutter in the middle of the piano.',
    blocks: [
      {
        kind: 'prose',
        text: 'A chord’s identity lives in its third and its seventh. The third tells you major or minor; the seventh tells you what kind of chord it is. The fifth tells you nothing at all and is nearly always disposable, and the root only needs playing when nobody else is playing it. So three notes — root, third, seventh — carry every tune you will ever play.',
      },
      {
        kind: 'prose',
      ...
      },
      {
        ...
        rows: [
          { symbol: 'Dm7 as 1-7-3', means: 'D, then the ♭7 of Dm7 above it, then the ♭3 above that', gives: 'D – C – F' },
      ...
      {
        kind: 'progression',
        label: 'What you just built',
        chords: ['Dm7', 'G7', 'Cmaj7'],
        highlight: 1,
        note: 'Alternating the two orders — 1-7-3, then 1-3-7, then 1-7-3 — is not an arbitrary rule. It is what keeps your hand still, and the next section shows why.',
      },
      {
        kind: 'prose',
        text: 'Look at what happens between those three shapes. The hand barely moves, and that is the point of alternating the orders rather than playing all three the same way.',
      },
      {
        kind: 'worked',
        label: 'Why the hand stays still',
        rows: [
          { symbol: 'Dm7 → G7, top note', means: 'F stays exactly where it is — the ♭3 of Dm7 is also the ♭7 of G7', gives: 'F – F' },
          { symbol: 'Dm7 → G7, middle', means: 'C drops one key to B — the ♭7 of Dm7 becomes the 3rd of G7', gives: 'C – B' },
          { symbol: 'G7 → Cmaj7, top', means: 'F drops one key to E — the ♭7 of G7 becomes the 3rd of Cmaj7', gives: 'F – E' },
          { symbol: 'G7 → Cmaj7, middle', means: 'B stays put — the 3rd of G7 is also the 7th of Cmaj7', gives: 'B – B' },
        ],
        note: 'Across the whole progression, only two notes ever move, and each moves by a single key. Everything else is a note the two chords share. If your hand is jumping around, you have the two orders the wrong way round.',
      },
      {
        kind: 'callout',
        title: 'This is what "voice leading" means',
        text: 'The phrase sounds technical but describes something simple: choosing which arrangement of a chord to play based on what you played last, so that each finger moves as little as possible. Voice leading is not a rule imposed on you — it is the reason one arrangement feels easy and another feels like a leap.',
      },
      {
        kind: 'prose',
        text: 'With the shell in the left hand, the right hand adds colour on top. The usual pair is the 9 and the 13 — in C, that is D and A over the Cmaj7. Four or five notes total, built from one rule, and it sounds like a record.',
      },
      {
        kind: 'worked',
        label: 'Adding the right hand over the same three chords',
        rows: [
          { symbol: 'Dm7', means: 'left hand D–C–F, right hand takes the 9 and the 11', gives: 'E and G on top' },
          { symbol: 'G7', means: 'left hand G–B–F, right hand takes the 9 and the 13', gives: 'A and E on top' },
          { symbol: 'Cmaj7', means: 'left hand C–B–E, right hand takes the 9 and the 13', gives: 'D and A on top' },
        ],
  ...
  },
  {
    ...
    blocks: [
      ...
      },
      {
        ...
        rows: [
          { symbol: 'Dm7♭5 as 1-♭7-♭3', means: 'root, the ♭7 above, the ♭3 above that', gives: 'D – C – F' },
