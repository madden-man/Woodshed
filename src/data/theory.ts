  ...
  },
  {
    ...
    blocks: [
      ...
      },
      {
        ...
        rows: [
          { symbol: 'Dm7 as 1-3-7', means: 'D, then the ♭3 above it, then the ♭7 above that — a minor 7th under the hand', gives: 'D – F – C' },
          { symbol: 'G7 as 1-3-7', means: 'G, then the 3rd above it, then the ♭7 above that — another minor 7th', gives: 'G – B – F' },
      ...
      {
        kind: 'prose',
        text: 'The guide tones still resolve properly, which is the part worth checking. Look at the top two notes of each shape as a pair, and one of them is always shared with the chord on either side.',
      },
      {
        kind: 'worked',
      ...
      {
        kind: 'callout',
        title: 'Why some books teach 1-7-3 instead',
        text: 'Alternating 1-7-3 and 1-3-7 keeps the very top note of the shape smooth as well, which matters when the shell is the top of what you are playing. But it costs you the reach: 1-7-3 on a Dm7 is D–C–F, a minor 10th, and in this progression it makes all three shapes span a 10th or more rather than a 7th. Under a right-hand melody that trade is not worth it. Learn 1-3-7 until the shapes are automatic, and pick up 1-7-3 later as a variation, not a default.',
      },
      {
        kind: 'worked',
  ...
  },
  {
    ...
    blocks: [
      ...
      },
      {
        ...
        ordered: true,
        items: [
          'Shell the whole thing first, using the three shapes above — all 5-3-1, none wider than a 7th.',
